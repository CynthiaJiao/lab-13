...
```
Engineer probably have the highest problem solving abilities, since solving problem is really a large part of their job... Then scientist and medic have second and third highest problem solving abilities, followed by workers, who need more instructions to get work done. I assume the sd across all 4 roles are the same, as the variance within each role population should probably be the same.
```{r}
